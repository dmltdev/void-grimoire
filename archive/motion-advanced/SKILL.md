...
domain: patterns
description: Use when reaching for advanced Framer Motion (motion/react) features in React/Next.js — drag, gestures, text animations, SVG path drawing, custom hooks, imperative sequences (useAnimate), loaders, and the full API decision tree. Requires motion-foundations.
depends-on: []
chains-to: null
suggests: []
---
