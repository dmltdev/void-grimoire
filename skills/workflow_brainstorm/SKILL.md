...
digraph brainstorming {
    ...
    "Invoke workflow:write-plan skill" [shape=doublecircle];
    ...
    "User reviews spec?" -> "Invoke workflow:write-plan skill" [label="approved"];
}
```

**The terminal state is invoking workflow:write-plan.** Do NOT invoke frontend-design, mcp-builder, or any other implementation skill. The ONLY skill you invoke after brainstorming is workflow:write-plan.
...
- Invoke the workflow:write-plan skill to create a detailed implementation plan
- Do NOT invoke any other skill. workflow:write-plan is the next step.
