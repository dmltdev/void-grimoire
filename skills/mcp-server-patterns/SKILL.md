...
domain: patterns
description: Use when building or maintaining MCP servers in Node/TypeScript — tools, resources, prompts, Zod schemas, stdio vs Streamable HTTP transport, SDK upgrades.
depends-on: []
chains-to: null
suggests: []
---
...
> Canonical reference: [Model Context Protocol spec](https://modelcontextprotocol.io/). This skill captures battle-tested patterns; defer to the upstream docs for current API.
