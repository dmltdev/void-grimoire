...
domain: patterns
description: Use when building or reviewing Nest.js backends — modules, controllers, providers, DI, DTO validation, guards, interceptors, pipes, config, and TypeScript backend patterns.
depends-on: []
chains-to: null
suggests: []
---
...
> Canonical reference: [Nest.js official docs](https://docs.nestjs.com/). This skill captures battle-tested patterns; defer to the upstream docs for current API.
