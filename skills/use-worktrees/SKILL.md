...
**Announce at start:** "I'm using the use-worktrees skill to set up an isolated workspace."
...
```
You: I'm using the use-worktrees skill to set up an isolated workspace.
...
- **develop-with-subagents** - REQUIRED before executing any tasks
