...
domain: patterns
description: Use when implementing Framer Motion (motion/react) animation patterns in React/Next.js code — buttons, modals, toasts, stagger, page transitions, exit animations, scroll, layout. Code-level patterns, distinct from the impeccable design-animate workflow.
depends-on: []
chains-to: null
suggests: []
---
