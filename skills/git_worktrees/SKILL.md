...
- **workflow:subagent-dev** - REQUIRED before executing any tasks
- **workflow:execute-plan** - REQUIRED before executing any tasks
- Any skill needing isolated workspace

**Pairs with:**
- **git:finish-branch** - REQUIRED for cleanup after work complete
