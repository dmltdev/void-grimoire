...
**Note:** Tell your human partner that this workflow works much better with access to subagents. The quality of its work will be significantly higher if run on a platform with subagent support (such as Claude Code or Codex). If subagents are available, use develop-with-subagents instead of this skill.
...
- **use-worktrees** - REQUIRED: Set up isolated workspace before starting
