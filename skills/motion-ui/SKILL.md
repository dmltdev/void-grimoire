...
name: motion-ui
domain: patterns
description: Use when wiring a Framer Motion (motion/react) UI motion system into a React/Next.js app — production-ready component motion, transitions, and motion patterns. Code-focused, distinct from the impeccable design-animate workflow.
depends-on: []
chains-to: null
suggests: []
---
