...
**Announce at start:** "I'm using the workflow:execute-plan skill to implement this plan."

**Note:** Tell your human partner that this workflow works much better with access to subagents. The quality of its work will be significantly higher if run on a platform with subagent support (such as Claude Code or Codex). If subagents are available, use workflow:subagent-dev instead of this skill.
...
- **REQUIRED SUB-SKILL:** Use git:finish-branch
