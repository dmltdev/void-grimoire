...
**Announce at start:** "I'm using the workflow:write-plan skill to create the implementation plan."
...
- **REQUIRED:** Use workflow:subagent-dev
- Do NOT offer a choice - subagent-driven is the standard approach
- Fresh subagent per task + two-stage review

**If harness does NOT have subagents:**
- Execute plan in current session using workflow:execute-plan
